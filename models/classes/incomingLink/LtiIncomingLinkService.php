 ...
 */
interface LtiIncomingLinkService
{
    const SERVICE_ID = 'taoLti/LtiIncomingLinkService';


    /**
     * @param $ltiLinkIdentifier
     * @return LtiIncomingLink
     */
